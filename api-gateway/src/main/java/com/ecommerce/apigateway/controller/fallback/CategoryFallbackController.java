...
/**
 * Fallback controller for Category endpoints.
 * Handles circuit breaker fallbacks when product-service (categories) is unavailable.
 */
@RestController
@RequestMapping("/fallback/categories")
@Slf4j
public class CategoryFallbackController {
